...
const translations: Record<Language, Translations> = {
  en: {
    ...
    services: {
      ...
      service1Desc: 'Professional installation of turbine systems designed for maximum efficiency and longevity.',
      service2Title: 'Assembly',
      service2Desc: 'Expert assembly of hydropower components and mechanical systems.',
      service3Title: 'Maintenance',
      service3Desc: 'Regular maintenance services to ensure optimal performance and extended equipment lifespan.',
      service4Title: 'Generator Bearing Replacement & Repairs',
      service4Desc: 'Specialized replacement of generator bearings and comprehensive repair services.',
      service5Title: '',
      service5Desc: '',
      service6Title: '',
      service6Desc: '',
    ...
    contactSection: {
      ...
      option1: 'Turbine Installation',
      option2: 'Assembly',
      option3: 'Maintenance',
      option4: 'Generator Bearing Replacement & Repairs',
  ...
  sq: {
    ...
    services: {
      ...
      service1Desc: 'Instalim profesional i sistemeve të turbinave të dizajnuara për efikasitet dhe jetëgjatësi maksimale.',
      service2Title: 'Montim',
      service2Desc: 'Montim ekspert i komponentëve hidroenergjetikë dhe sistemeve mekanike.',
      service3Title: 'Mirëmbajtje',
      service3Desc: 'Shërbime të rregullta mirëmbajtjeje për të siguruar performancë optimale dhe jetëgjatësi të zgjatur të pajisjeve.',
      service4Title: 'Ndërrim Guzhinetash të Gjeneratorëve dhe Riparime',
      service4Desc: 'Ndërrim i specializuar i guzhinetave të gjeneratorëve dhe shërbime gjithëpërfshirëse riparimi.',
      service5Title: '',
      service5Desc: '',
      service6Title: '',
      service6Desc: '',
    ...
    contactSection: {
      ...
      option1: 'Instalimi i Turbinave',
      option2: 'Montim',
      option3: 'Mirëmbajtje',
      option4: 'Ndërrim Guzhinetash të Gjeneratorëve dhe Riparime',
